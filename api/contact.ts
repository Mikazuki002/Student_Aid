...
export default async function handler(
  ...
  // Cross-origin requests (e.g., from studentaidsupport.us) trigger
  // a preflight OPTIONS check that needs these headers to succeed
  ...
  // Only accept POST requests (after OPTIONS is handled)
  if (req.method !== 'POST') {
